...
})({"tDFxu":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "cd37f5367825b3bb";
...
},{}],"iYHaA":[function(require,module,exports) {
var _mainElm = require("./src/Main.elm");
const programBase64 = "";
const programs = {
    testOpcode: programBase64,
    randomNumberTest: `ZQAA4MP/oiLzM/JlZADwKdRVdAXxKdRVdAXyKdRV8woSAg==`,
    delayTimerTest: `ZAAiHvUKRQJ2AUUIdv81BRIC9hX2ByIeNgASFBICAOCiOvYz8mVjAPAp00VzBfEp00VzBfIp00UA7g==`,
    ibmLogo: `AOCiKmAMYQjQH3AJojnQH6JIcAjQH3AEolfQH3AIombQH3AIonXQHxIo/wD/ADwAPAA8ADwA/wD//wD/ADgAPwA/ADgA/wD/gADgAOAAgACAAOAA4ACA+AD8AD4APwA7ADkA+AD4AwAHAA8AvwD7APMA4wBD4ADgAIAAgACAAIAA4ADg`,
    bcTest: ``
};
function printProgram(s1) {
    const ops = s1.match(/.{4}/g).map((s)=>"0x" + s.toUpperCase());
    console.log(ops);
}
const app = (0, _mainElm.Elm).Main.init({
    flags: {
        program: programs.testOpcode,
        // program: programBase64,
        // program: programs.randomNumberTest,
        // program: programs.delayTimerTest,
        // program: programs.ibmLogo,
        // program: programs.bcTest,
        seed: Date.now()
    }
});
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Rom$corax89Test = A4($author$project$Rom$Rom, $author$project$Rom$Test, "corax89's opcode tests", _List_fromArray([
        18,
        78,
        234,
        172,
    ...
    var $author$project$Cpu$fontSprites = $elm$core$List$concat(_List_fromArray([
        _List_fromArray([
            240,
            144,
            144,
    ...
    var $author$project$Array$Extra$take = function(n) {
        return A2($elm$core$Array$slice, 0, n);
    };
    var $author$project$Array$Extra$zeroed = function(len) {
        return A2($elm$core$Array$initialize, len, function(_v0) {
            return 0;
        });
    };
    var $author$project$Cpu$reservedMem = A2($author$project$Array$Extra$take, 512, A2($elm$core$Array$append, $elm$core$Array$fromList($author$project$Cpu$fontSprites), $author$project$Array$Extra$zeroed(512)));
    var $author$project$Cpu$load = F2(function(bytes, cpu) {
        var mem = A2($author$project$Array$Extra$take, 4096, A2($elm$core$Array$append, A2($elm$core$Array$append, $author$project$Cpu$reservedMem, $elm$core$Array$fromList(bytes)), $author$project$Array$Extra$zeroed(4096)));
    ...
    var $author$project$Cpu$new = function(seed) {
        return {
            ...
            mem: A2($author$project$Array$Extra$take, 4096, A2($elm$core$Array$append, $author$project$Cpu$reservedMem, $author$project$Array$Extra$zeroed(4069))),
            pc: 512,
            seed: seed,
            soundTimer: 0,
            stack: _List_Nil,
    ...
    var $author$project$Main$init = function(flags) {
        return _Utils_Tuple2(A2($author$project$Main$initModel, A2($elm$core$Maybe$withDefault, 0, flags.seed), $author$project$Rom$corax89Test.program), $elm$core$Platform$Cmd$none);
    };
    ...
    var $author$project$Main$subscriptions = function(model) {
        return $elm$core$Platform$Sub$batch(_List_fromArray([
            ...
            function() {
                ...
                if (_v1.$ === "Running") return $elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Main$Tick);
    ...
    var $author$project$Rom$ibmLogo = A4($author$project$Rom$Rom, $author$project$Rom$Test, "IBM logo", _List_fromArray([
        0,
        224,
        162,
        42,
    ...
    var $author$project$Rom$all = $elm$core$Dict$fromList(_List_fromArray([
        $author$project$Rom$pair($author$project$Rom$corax89Test),
        $author$project$Rom$pair($author$project$Rom$ibmLogo),
    ...
    var $author$project$Main$instrPerSecond = 700;
    ...
    var $author$project$Registers$set = F3(function(r, v, _v0) {
        var array = _v0.a;
        return $author$project$Registers$Registers(A3($elm$core$Array$set, $author$project$Register$toInt(r), v, array));
    });
        ...
        var cpu1 = function() {
            ...
            if (_v0.$ === "Nothing") return cpu;
                ...
                return _Utils_update(cpu, {
                    awaitingKeyPress: $elm$core$Maybe$Nothing,
                    pc: cpu.pc + 2,
                    v: A3($author$project$Registers$set, reg, keyValue, cpu.v)
                });
            }
        }();
    ...
    var $author$project$Registers$get = F2(function(r, _v0) {
        var array = _v0.a;
        return A2($elm$core$Maybe$withDefault, -1, A2($elm$core$Array$get, $author$project$Register$toInt(r), array));
    });
    ...
    var $author$project$FrameBuffer$setPixel = F3(function(x_, y_, _v0) {
        var array = _v0.a;
        ...
        var idx = x + y * $author$project$FrameBuffer$cols;
    ...
    var $author$project$Cpu$wrapByte = function(_byte) {
        return A2($elm$core$Basics$modBy, 256, _byte);
    };
    ...
    var $author$project$Cpu$execute = F2(function(op, cpu) {
        switch(op.$){
            ...
            case "Add":
                var x = op.a;
                var kk = op.b;
                var sum = $author$project$Cpu$wrapByte(A2($author$project$Registers$get, x, cpu.v) + kk);
                return $elm$core$Result$Ok(_Utils_update(cpu, {
                    pc: cpu.pc + 2,
            ...
            case "Or":
                ...
                return $elm$core$Result$Ok(_Utils_update(cpu, {
                    pc: cpu.pc + 2,
                    v: A3($author$project$Registers$set, x, vx1 | vy, cpu.v)
                }));
            case "And":
                var x = op.a;
                var y = op.b;
            ...
            case "Addvv":
                ...
                return $elm$core$Result$Ok(_Utils_update(cpu, {
                    pc: cpu.pc + 2,
                    v: A3($author$project$Registers$set, $author$project$Register$VF, carry, A3($author$project$Registers$set, x, lo, cpu.v))
                }));
            case "Sub":
                var x = op.a;
                var y = op.b;
                var vy = A2($author$project$Registers$get, y, cpu.v);
                var vx1 = A2($author$project$Registers$get, x, cpu.v);
                var diff = $author$project$Cpu$wrapByte(vx1 - vy);
                var borrow = _Utils_cmp(vx1, vy) > 0 ? 1 : 0;
                return $elm$core$Result$Ok(_Utils_update(cpu, {
                    pc: cpu.pc + 2,
                    v: A3($author$project$Registers$set, $author$project$Register$VF, borrow, A3($author$project$Registers$set, x, diff, cpu.v))
                }));
            case "Shr":
                var x = op.a;
                var vx1 = A2($author$project$Registers$get, x, cpu.v);
                ...
                return $elm$core$Result$Ok(_Utils_update(cpu, {
                    pc: cpu.pc + 2,
                    v: A3($author$project$Registers$set, $author$project$Register$VF, lsb, A3($author$project$Registers$set, x, vx1 >> 1, cpu.v))
                }));
            case "Subn":
                var x = op.a;
                var y = op.b;
                var vy = A2($author$project$Registers$get, y, cpu.v);
                var vx1 = A2($author$project$Registers$get, x, cpu.v);
                var diff = $author$project$Cpu$wrapByte(vy - vx1);
                var borrow = _Utils_cmp(vy, vx1) > 0 ? 1 : 0;
                return $elm$core$Result$Ok(_Utils_update(cpu, {
                    pc: cpu.pc + 2,
                    v: A3($author$project$Registers$set, $author$project$Register$VF, borrow, A3($author$project$Registers$set, x, diff, cpu.v))
                }));
            case "Shl":
                ...
                var vx1 = A2($author$project$Registers$get, x, cpu.v);
                var msb = (vx1 & 128) >> 7;
                var doubled = $author$project$Cpu$wrapByte(vx1 << 1);
                return $elm$core$Result$Ok(_Utils_update(cpu, {
                    pc: cpu.pc + 2,
                    v: A3($author$project$Registers$set, $author$project$Register$VF, msb, A3($author$project$Registers$set, x, doubled, cpu.v))
                }));
            case "Ldi":
                var addr = op.a;
                return $elm$core$Result$Ok(_Utils_update(cpu, {
            ...
            case "Rnd":
                ...
                var randByte = kk & $author$project$Cpu$wrapByte(newSeed);
                return $elm$core$Result$Ok(_Utils_update(cpu, {
                    pc: cpu.pc + 2,
                    seed: newSeed,
            ...
            case "Drw":
                ...
                var getSprite = F2(function(row, cpu_) {
                    return A2($elm$core$Maybe$withDefault, 0, A2($elm$core$Array$get, cpu_.i + row, cpu.mem));
                });
                    ...
                    help: while(true){
                        if (_Utils_cmp(row, spriteHeight) < 0) {
                            if (_Utils_cmp(col, width) < 0) {
                                var newCpu = function() {
                                    if ((128 & sprite) > 0) {
                                        var _v2 = A3($author$project$FrameBuffer$setPixel, A2($author$project$Registers$get, x, cpu.v) + col, A2($author$project$Registers$get, y, cpu.v) + row, c.frameBuf);
                                        var collided = _v2.a;
                                        var fb = _v2.b;
                                        var newV = collided ? A3($author$project$Registers$set, $author$project$Register$VF, 1, c.v) : c.v;
                                ...
                                var $temp$row = row, $temp$col = col + 1, $temp$sprite = sprite << 1, $temp$c = newCpu;
                                row = $temp$row;
                                col = $temp$col;
                                sprite = $temp$sprite;
                                c = $temp$c;
                ...
                return $elm$core$Result$Ok(function(c) {
                    ...
                    v: A3($author$project$Registers$set, $author$project$Register$VF, 0, cpu.v)
                }))));
            case "Skp":
                var x = op.a;
                var vx1 = A2($author$project$Registers$get, x, cpu.v);
                return A2($elm$core$Set$member, vx1, cpu.keysDown) ? $elm$core$Result$Ok(_Utils_update(cpu, {
                    pc: cpu.pc + 4
                })) : $elm$core$Result$Ok(_Utils_update(cpu, {
                    pc: cpu.pc + 2
                }));
            ...
            case "Ldbv":
                ...
                return $elm$core$Result$Ok(_Utils_update(cpu, {
                    mem: A3($elm$core$Array$set, cpu.i + 2, ones, A3($elm$core$Array$set, cpu.i + 1, tens, A3($elm$core$Array$set, cpu.i, hundreds, cpu.mem))),
                    pc: cpu.pc + 2
                }));
            case "Ldiv":
                var x = op.a;
            ...
            default:
                ...
                var v = A3($elm$core$List$foldl, F2(function(reg, acc) {
                    var memIdx = cpu.i + $author$project$Register$toInt(reg);
                    var memVal = A2($elm$core$Maybe$withDefault, 0, A2($elm$core$Array$get, memIdx, cpu.mem));
    ...
    var $author$project$Cpu$fetchOp = function(cpu) {
        return A2($elm$core$Maybe$andThen, function(hi) {
            return A2($elm$core$Maybe$map, function(lo) {
                return hi << 8 | lo;
            }, A2($elm$core$Array$get, cpu.pc + 1, cpu.mem));
        }, A2($elm$core$Array$get, cpu.pc, cpu.mem));
    };
                ...
                if (!(61440 & n)) return $elm$core$Maybe$Just($author$project$OpCode$Sys(n & 4095));
                    ...
                    if ((61440 & n) === 4096) return $elm$core$Maybe$Just($author$project$OpCode$Jp(n & 4095));
                        ...
                        if ((61440 & n) === 8192) return $elm$core$Maybe$Just($author$project$OpCode$Call(n & 4095));
                            ...
                            if ((61440 & n) === 12288) return A3($elm$core$Maybe$map2, $author$project$OpCode$Se, $author$project$Register$fromInt((3840 & n) / 256 | 0), $elm$core$Maybe$Just(255 & n));
                            else {
                                if ((61440 & n) === 16384) return A3($elm$core$Maybe$map2, $author$project$OpCode$Sne, $author$project$Register$fromInt((3840 & n) / 256 | 0), $elm$core$Maybe$Just(255 & n));
                                else {
                                    if ((61455 & n) === 20480) return A3($elm$core$Maybe$map2, $author$project$OpCode$Sev, $author$project$Register$fromInt((3840 & n) / 256 | 0), $author$project$Register$fromInt((240 & n) / 16 | 0));
                                        ...
                                        if ((61440 & n) === 24576) return A3($elm$core$Maybe$map2, $author$project$OpCode$Ldv, $author$project$Register$fromInt((3840 & n) / 256 | 0), $elm$core$Maybe$Just(255 & n));
                                        else {
                                            if ((61440 & n) === 28672) return A3($elm$core$Maybe$map2, $author$project$OpCode$Add, $author$project$Register$fromInt((3840 & n) / 256 | 0), $elm$core$Maybe$Just(255 & n));
                                            else {
                                                                                ...
                                                                                if ((61455 & n) === 32782) return A3($elm$core$Maybe$map2, $author$project$OpCode$Shl, $author$project$Register$fromInt((3840 & n) / 256 | 0), $author$project$Register$fromInt((240 & n) / 16 | 0));
                                                                                    ...
                                                                                    if ((61440 & n) === 36864) return A3($elm$core$Maybe$map2, $author$project$OpCode$Snev, $author$project$Register$fromInt((3840 & n) / 256 | 0), $author$project$Register$fromInt((240 & n) / 16 | 0));
                                                                                        ...
                                                                                        if ((61440 & n) === 40960) return $elm$core$Maybe$Just($author$project$OpCode$Ldi(4095 & n));
                                                                                            ...
                                                                                            if ((61440 & n) === 49152) return A3($elm$core$Maybe$map2, $author$project$OpCode$Rnd, $author$project$Register$fromInt((3840 & n) / 256 | 0), $elm$core$Maybe$Just(255 & n));
                                                                                            else {
    ...
    var $author$project$Cpu$step1 = function(cpu) {
        ...
        if (_v0.$ === "Nothing") return $elm$core$Result$Err($author$project$Cpu$ProgramCounterOutOfRange(cpu.pc));
            ...
            if (_v1.$ === "Nothing") return $elm$core$Result$Err($author$project$Cpu$UnknownOpCode(code));
                ...
                var op = _v1.a;
                return A2($elm$core$Result$map, $elm$core$Tuple$pair(op), A2($author$project$Cpu$execute, op, cpu));
            }
        }
    };
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        switch(msg.$){
            ...
            case "Tick":
                var delta = msg.a;
                var instrCount = A2($elm$core$Basics$max, 1, $elm$core$Basics$floor(delta / 1000 * $author$project$Main$instrPerSecond));
                var _v1 = A2($author$project$Cpu$step, instrCount, model.cpu);
                if (_v1.$ === "Err") return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                    ...
                    return _Utils_Tuple2(_Utils_update(model, {
                        cpu: function(c) {
                            return _Utils_update(c, {
                                delayTimer: !c.delayTimer ? 0 : c.delayTimer - 1
                            });
                        }(cpu),
                        ops: A2($elm$core$List$take, 100, A3($elm$core$List$foldr, $elm$core$List$cons, model.ops, ops))
            ...
            case "RomSelected":
                var name = msg.a;
                var _v3 = A2($elm$core$Dict$get, name, $author$project$Rom$all);
                if (_v3.$ === "Nothing") return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                else {
                    var rom = _v3.a;
            ...
            default:
                var steps = msg.a;
                var _v4 = A2($author$project$Cpu$step, steps, model.cpu);
                if (_v4.$ === "Err") return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                else {
                    var _v5 = _v4.a;
                    var ops = _v5.a;
                    var cpu = _v5.b;
    ...
    var $author$project$Main$viewCpu = function(cpu) {
        return A2($elm$html$Html$ul, _List_Nil, _List_fromArray([
            ...
            A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                $elm$html$Html$text("Delay timer: " + $elm$core$String$fromInt(cpu.delayTimer))
            ])),
            A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                $elm$html$Html$text("Sound timer: " + $elm$core$String$fromInt(cpu.soundTimer))
            ])),
            A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                $elm$html$Html$text("Stack: "),
                $elm$html$Html$text($elm$core$List$isEmpty(cpu.stack) ? "--" : "")
            ])),
            A2($elm$html$Html$ul, _List_Nil, A2($elm$core$List$map, function(addr) {
                return A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                    $elm$html$Html$text($author$project$Main$to0xHexString(addr))
                ]));
            }, cpu.stack)),
            A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                $elm$html$Html$text("I: " + $author$project$Main$showNumber(cpu.i))
            ])),
            A2($elm$html$Html$ul, _List_Nil, A2($elm$core$List$indexedMap, F2(function(i, reg) {
                var vx = A2($author$project$Registers$get, reg, cpu.v);
                return A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                    $elm$html$Html$text("V" + ($rtfeldman$elm_hex$Hex$toString(i) + (": " + ("0x" + A3($elm$core$String$padLeft, 2, _Utils_chr("0"), $rtfeldman$elm_hex$Hex$toString(vx))))))
                ]));
    ...
    var $author$project$OpCode$toDebugString = function(op) {
        var toHex = function(n_) {
            return "0x" + A3($elm$core$String$padLeft, 2, _Utils_chr("0"), $rtfeldman$elm_hex$Hex$toString(n_));
        };
        switch(op.$){
            case "Cls":
                return "CLS";
            ...
            case "Se":
                var x = op.a;
                var kk = op.b;
                return "SE V" + ($rtfeldman$elm_hex$Hex$toString($author$project$Register$toInt(x)) + (", " + toHex(kk)));
            case "Sne":
                var x = op.a;
                var kk = op.b;
                return "SNE V" + ($rtfeldman$elm_hex$Hex$toString($author$project$Register$toInt(x)) + (", " + toHex(kk)));
            case "Sev":
                var x = op.a;
                var y = op.b;
            ...
            case "Ldv":
                var x = op.a;
                var kk = op.b;
                return "LD V" + ($rtfeldman$elm_hex$Hex$toString($author$project$Register$toInt(x)) + (", " + toHex(kk)));
            case "Add":
                var x = op.a;
                var kk = op.b;
                return "ADD V" + ($rtfeldman$elm_hex$Hex$toString($author$project$Register$toInt(x)) + (", " + toHex(kk)));
            case "Ldvv":
                var x = op.a;
                var y = op.b;
            ...
            case "Snev":
                var a = op.a;
                var b = op.b;
                return "SNE V" + ($rtfeldman$elm_hex$Hex$toString($author$project$Register$toInt(a)) + (", V" + $rtfeldman$elm_hex$Hex$toString($author$project$Register$toInt(b))));
            case "Ldi":
                var addr = op.a;
            ...
            case "Rnd":
                var x = op.a;
                var kk = op.b;
                return "RND V" + ($rtfeldman$elm_hex$Hex$toString($author$project$Register$toInt(x)) + (", " + toHex(kk)));
            case "Drw":
                var x = op.a;
                var y = op.b;
                var nibble = op.c;
    ...
    var $author$project$Main$viewOpCodeHistory = function(ops) {
        return A2($elm$html$Html$div, _List_Nil, _List_fromArray([
            A2($elm$html$Html$ul, _List_Nil, A2($elm$core$List$map, function(op) {
                return A2($elm$html$Html$li, _List_Nil, _List_fromArray([
                    $elm$html$Html$text($author$project$OpCode$toDebugString(op))
                ]));
            }, A2($elm$core$List$take, 10, ops)))
        ]));
    };
    var $author$project$Main$view = function(model) {
        return {
            body: _List_fromArray([
                A2($elm$html$Html$label, _List_Nil, _List_fromArray([
                    ...
                    A2($elm$html$Html$select, _List_fromArray([
                        ...
                        A2($elm$html$Html$optgroup, _List_fromArray([
                            ...
                            return _Utils_eq(rom.kind, $author$project$Rom$Demo);
                        }, $elm$core$Dict$values($author$project$Rom$all)))),
                        A2($elm$html$Html$optgroup, _List_fromArray([
                            A2($elm$html$Html$Attributes$attribute, "label", "Games")
                        ]), A2($elm$core$List$map, function(rom) {
                            return A2($elm$html$Html$option, _List_fromArray([
                                $elm$html$Html$Attributes$value(rom.name),
                                $elm$html$Html$Attributes$selected(_Utils_eq(model.program, rom.program))
                            ...
                            return _Utils_eq(rom.kind, $author$project$Rom$Game);
                        }, $elm$core$Dict$values($author$project$Rom$all))))
                    ]))
                ])),
                ...
                $author$project$Main$viewOpCodeHistory(model.ops),
                $author$project$Main$viewCpu(model.cpu),
...
},{}]},["tDFxu","iYHaA"], "iYHaA", "parcelRequire94c2")

//# sourceMappingURL=index.7825b3bb.js.map
